...
export declare class CKANUserService {
    static get(type: "list" | "show" | "api_token_list", data: Partial<CKANAPIUserhowProps | CKANAPIUserListProps | CKANAPIUserTokenProps>): Promise<CKANAPIUserListResponse | CKANAPIUserShowResponse | CKANAPIUserTokenResponse>;
