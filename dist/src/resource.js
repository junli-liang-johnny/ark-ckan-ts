...
var CKANResourceService = /** @class */ (function () {
    ...
    CKANResourceService.dcatDistributionURL = function (datasetId, resourceId) {
        return "".concat(base_1.CKANAPIBase.BASE_CKAN_URL, "/dataset/").concat(datasetId, "/resource/").concat(resourceId);
    };
    CKANResourceService.get = function (action, data, headers) {
        return new Promise(function (resolve, reject) {
            var url;
            if (action === 'search')
                url = "".concat(base_1.CKANAPIBase.BASE_CKAN_API_URL, "/resource_search?").concat(new URLSearchParams(data).toString());
            else if (action === 'show')
                url = "".concat(base_1.CKANAPIBase.BASE_CKAN_API_URL, "/resource_show?").concat(new URLSearchParams(data).toString());
            else
                url = "".concat(base_1.CKANAPIBase.BASE_CKAN_API_URL, "/resource_show?").concat(new URLSearchParams(data).toString());
    ...
    CKANResourceService.create = function (data) {
        return new Promise(function (resolve, reject) {
            var url = "".concat(base_1.CKANAPIBase.BASE_CKAN_API_URL, "/resource_create");
    ...
    CKANResourceService.update = function (data) {
        return new Promise(function (resolve, reject) {
            var url = "".concat(base_1.CKANAPIBase.BASE_CKAN_API_URL, "/resource_update");
