...
export interface CKANAPIUserListResponse extends Omit<CKANAPIGetListResponse, "result"> {
    result: CKANAPIUser[];
}
...
export interface CKANOrganisationListResponse extends CKANAPIListResponse<CKANAPIOrganisation> {
}
export {};
