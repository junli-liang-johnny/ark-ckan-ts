...
exports.revokeUserAPIToken = exports.getUserAPITokenList = exports.requestAPIToken = exports.getUserAPIToken = exports.getCKANDatasetAutocomplete = exports.searchCKANDatasetSync = exports.searchCKANDataset = exports.loadCKANDatasetSync = exports.loadCKANDataset = exports.CKANAPIBase = exports.CKAN_API_TOKEN_LOCALSTORAGE_KEY = void 0;
var _1 = require(".");
...
var CKANAPIBase = /** @class */ (function () {
    ...
    CKANAPIBase.BASE_CKAN_URL = 'https://openark.adaptcentre.ie/ARKEvidence';
    ...
    CKANAPIBase.API_KEY = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJqdGkiOiJHV2NEWGhvdW9HRVRWM0N0MGhxdFkzRjJ2ZFY1MGgzU0x1ZFd1UmxmSEZsSTBuTWxVZXVPanJ6LXN0YXh3enJ2U0lfWHRYTVljYUpmOXI5QiIsImlhdCI6MTYyMTUxMjAxN30.1gHrU7hgSf6QC6MHUym8YdGliB4DkTbRakwDCyLxt8s';
    CKANAPIBase.API_KEY_ID = 'GWcDXhouoGETV3Ct0hqtY3F2vdV50h3SLudWuRlfHFlI0nMlUeuOjrz-staxwzrvSI_XtXMYcaJf9r9B';
...
var loadCKANDataset = function (username, onOneDataLoaded, onFinish) { return __awaiter(void 0, void 0, void 0, function () {
...
var loadCKANDatasetSync = function (username, onOneDataLoaded) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                if (admin)
                    return [2 /*return*/, CKANAPIBase.API_KEY];
                if (!(localStorage && localStorage.getItem(exports.CKAN_API_TOKEN_LOCALSTORAGE_KEY))) return [3 /*break*/, 1];
                if (callback)
                    callback(localStorage.getItem(exports.CKAN_API_TOKEN_LOCALSTORAGE_KEY));
                return [2 /*return*/, localStorage.getItem(exports.CKAN_API_TOKEN_LOCALSTORAGE_KEY)];
