    ...
    CKANGroupService.get = function (data) {
        return new Promise(function (resolve, reject) {
            ...
            if (Object.keys(data).every(function (el) { return getListParamArray.includes(el); }))
                url = "".concat(_1.CKANAPIBase.BASE_CKAN_API_URL, "/group_list?").concat(new URLSearchParams(data).toString());
            else
                url = "".concat(_1.CKANAPIBase.BASE_CKAN_API_URL, "/group_show?").concat(new URLSearchParams(data).toString());
